    ...
    return (
        <form onSubmit={handleSubmit} className="space-y-6 w-full max-w-md mx-auto">
            ...
            <div className="space-y-2">
                ...
                >
                    <SelectTrigger className="bg-white/90 backdrop-blur-sm border">
                        <SelectValue placeholder="Select your role" />
                    </SelectTrigger>
                    <SelectContent className="bg-white border shadow-md">
                        <SelectGroup>
                            <SelectItem value="teacher" className="cursor-pointer hover:bg-gray-100">Teacher</SelectItem>
                            <SelectItem value="student" className="cursor-pointer hover:bg-gray-100">Student</SelectItem>
                        </SelectGroup>
                    </SelectContent>
                </Select>
            </div>
